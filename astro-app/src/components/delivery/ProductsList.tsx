...
/**
 * Lista de productos
 * Renderiza cada producto con su imagen, nombre, precio y contador
 */
const ProductsList: React.FC<ProductsListProps> = ({ prods }) => {
          ...
          >
            ...
            <figcaption className="p-5 flex flex-col gap-3">
              ...
              <p className="text-sm text-zinc-600">
                <span className="text-blaze-orange-600 font-bold text-lg">
                  COP${prod.price}k
                </span>
