 ...
 * Muestra los items del carrito y permite proceder al pago
 */
...
/**
 * Componente interno que muestra el carrito vacío o lleno
 */
    ...
    return (
      <>
        ...
        <footer className="border-t border-zinc-200 p-6 flex flex-wrap gap-3 justify-end bg-zinc-50">
          ...
          <button className="px-6 h-10 rounded-lg bg-blaze-orange-600 hover:bg-blaze-orange-700 text-white font-bold shadow-lg shadow-blaze-orange-600/30 transition-all">
            Proceder al Pago
          </button>
        </footer>
      </>
  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 px-4">
      ...
      <p className="text-zinc-500 mb-8">
        Tu carrito está vacío. ¡Agrega algunos productos deliciosos!
      </p>
      <img
        src="./assets/6011.jpg"
        alt="Carrito vacío"
